...
public abstract class ProjectBlackWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ProjectBlackWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProjectBlackWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ProjectBlackDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ProjectBlackDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ProjectBlackDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ProjectBlackDbContext, Task<T>> func)
    {
        T result;

...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = ProjectBlackConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(ProjectBlackDbContext context)
    {
        _context = context;
    }
